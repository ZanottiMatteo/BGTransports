...
public class HomeView extends JFrame {
	 ...
	 */
	/*
	 * private JButton createMenuButton(ImageIcon icon, int x, int y) { JButton
	 * button = new JButton(); button.setBounds(x, y, 60, 60); button.setIcon(icon);
	 * button.setBorderPainted(false); button.setRolloverEnabled(false);
	 * button.setBackground(new Color(0, 0, 0, 0)); return button; }
	 */
