...
/**
 * CompanyWidget is a panel that displays buttons representing different
 * companies, each with an associated logo and link to their respective web
 * pages.
 */
public class CompanyWidget extends RoundedPanel {
	...
	/**
	 * Constructor for CompanyWidget. Initializes the layout and adds components for
	 * displaying company-related buttons.
	 */
	...
	/**
	 * Sets up action listeners for the company buttons to open respective web
	 * pages.
	 */
	private void setupActionListeners() {
		atbButton.addActionListener(e -> WebPageController.openWebPage("https://atb.bergamo.it/il-gruppo/societa"));

		tebButton.addActionListener(e -> WebPageController.openWebPage("https://www.teb.bergamo.it/it/dati-societari"));

		trenordButton.addActionListener(e -> WebPageController.openWebPage("https://www.trenord.it/chi-siamo/"));

		usButton.addActionListener(e -> WebPageController.openWebPage("https://github.com/ZanottiMatteo/BGTransports"));
	}
}
