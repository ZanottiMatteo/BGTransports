...
/**
 * The InsertDataDB class is responsible for reading JSON data from specified files
 * and inserting the data into the appropriate database tables using jOOQ.
 */
public class InsertDataDB {

    /**
     * Inserts company records from a JSON file into the Company table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of company records inserted
    ...
    /**
     * Inserts pullman stop records from a JSON file into the Pullmanstop table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of pullman stop records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts funicular station records from a JSON file into the Funicularstation table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of funicular station records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts tram stop records from a JSON file into the Tramstop table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of tram stop records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts train station records from a JSON file into the Trainstation table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of train station records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts funicular timetable records from a JSON file into the Funiculartimetable table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of funicular timetable records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts tram timetable records from a JSON file into the Tramtimetable table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of tram timetable records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts train timetable records from a JSON file into the Traintimetable table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of train timetable records inserted
     * @throws IOException if there is an error reading the JSON file
     */
    ...
    /**
     * Inserts pullman timetable records from a JSON file into the Pullmantimetable table.
     * 
     * @param create the DSLContext used for database operations
     * @return the number of pullman timetable records inserted
     * @throws IOException if there is an error reading the JSON file
     */
